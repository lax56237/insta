...
export default function Profile() {
    ...
    const sendStory = async () => {
        if (!videoString) return alert("Select a video first!");
                ...
                <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
                    <div className="bg-neutral-900 p-5 rounded-xl w-80 border border-gray-700">
                        ...
                        <ul className="mt-4 space-y-3">
                            {stories[currentStoryIndex].views.map((v: { userPic: any; username: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; }, i: Key | null | undefined) => (
                                <li
                                    key={i}
